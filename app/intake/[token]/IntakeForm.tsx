    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center p-8">
        <div className="text-center space-y-4 max-w-sm">
          <div className="w-12 h-12 rounded-full bg-[#1787ff] flex items-center justify-center mx-auto">
        ...
        <div className="mx-auto max-w-xl space-y-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  return (
                    <button
                      ...
                      className={`rounded-full px-4 py-2 text-sm font-medium border transition-colors ${
                        active
                          ? "bg-[#1787ff] text-white border-[#1787ff]"
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full rounded-xl bg-[#1787ff] hover:bg-[#1270e0] px-4 py-3 text-sm font-semibold text-white disabled:opacity-30 transition-colors"
            >
